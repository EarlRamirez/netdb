#!/usr/bin/perl
###########################################################################
# force10scraper.pl - Fortigate Scraper Plugin
# Author: Jonathan Yantis <yantisj@gmail.com>
# Copyright (C) 2014 Jonathan Yantis
###########################################################################
# 
# Supports L2 only scraping, no ARP support
#
# force10scraper.pl -d switch.domain.com[,arp,vrf-dmz,forcessh] \
...
sub usage {
    print <<USAGE;
    Usage: force10scraper.pl [options] 
